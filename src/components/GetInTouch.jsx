      ...
      <div className="relative z-10 w-full mx-auto px-4 sm:px-8 lg:px-16 2xl:px-32">
        <div className="grid grid-cols-1 lg:grid-cols-[5fr_8fr] gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            <p className="text-white/90 text-lg md:text-2xl xl:text-[30px] leading-snug mb-8 md:mb-14">Let Us Know How We Can Help</p>

            {/* Contact Details */}
            <div className="space-y-7 md:space-y-11">
              {/* Call Us */}
              <div>
                <p className="text-[#45ADFF] text-xl md:text-2xl xl:text-[30px] font-medium uppercase tracking-[0.04em] mb-2 flex items-center gap-3">
                  <FaPhoneAlt size={32} /> <span>CALL US</span>
                </p>
                <p className="text-white text-xl md:text-2xl xl:text-[30px] font-bold">+91 90540 74748</p>
              </div>

              {/* Email Us */}
              <div>
                <p className="text-[#45ADFF] text-xl md:text-2xl xl:text-[30px] font-medium uppercase tracking-[0.04em] mb-2 flex items-center gap-3">
                  <FaEnvelope size={32} /> <span>EMAIL US</span>
                </p>
                <p className="text-white text-xl md:text-2xl xl:text-[30px] font-bold">info@gravitytechworld.com</p>
              </div>

              {/* Location */}
              <div>
                <p className="text-[#45ADFF] text-xl md:text-2xl xl:text-[30px] font-medium uppercase tracking-[0.04em] mb-2 flex items-center gap-3">
                  <FaMapMarkerAlt size={32} /> <span>LOCATION</span>
                </p>
                <p className="text-white text-xl md:text-2xl xl:text-[30px] font-bold leading-relaxed">
          ...
          >
            <form className="space-y-5" onSubmit={handleSubmit}>
              {/* Full Name */}
              <div>
                <label className="text-[#45ADFF] text-lg md:text-xl xl:text-[26px] font-medium mb-3 block">Full Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
                  ...
                  className="w-full bg-white/[0.10] border border-white/10 rounded-[15px] px-6 py-4 md:py-5 text-white text-base md:text-lg placeholder:text-white/35 focus:outline-none focus:border-[#45ADFF]/60 transition-colors"
                />
              </div>

              {/* Email */}
              <div>
                <label className="text-[#45ADFF] text-lg md:text-xl xl:text-[26px] font-medium mb-3 block">Email</label>
                <input
                  type="email"
                  name="email"
              ...
              {/* Subject */}
              <div>
                <label className="text-[#45ADFF] text-lg md:text-xl xl:text-[26px] font-medium mb-3 block">Subject</label>
                <input
                  type="text"
                  name="subject"
              ...
              {/* Your Message */}
              <div>
                <label className="text-[#45ADFF] text-lg md:text-xl xl:text-[26px] font-medium mb-3 block">Your Message</label>
                <textarea
                  name="message"
                  ...
                  rows={4}
                  className="w-full bg-white/[0.10] border border-white/10 rounded-[15px] px-6 py-4 md:py-5 text-white text-base md:text-lg placeholder:text-white/35 focus:outline-none focus:border-[#45ADFF]/60 transition-colors resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 md:py-5 rounded-[15px] bg-[#5CB8FF] text-white font-semibold text-lg md:text-xl hover:bg-[#45ADFF] active:scale-[0.98] transition-all cursor-pointer shadow-lg shadow-[#5CB8FF]/20 disabled:opacity-70 disabled:cursor-not-allowed"
              >
