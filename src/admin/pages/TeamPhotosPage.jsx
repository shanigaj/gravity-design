...
export default function TeamPhotosPage() {
  ...
  const labels = [
    'Column 1 — Tall Card (Left)',
    'Column 2 — Top',
    'Column 2 — Bottom',
    'Column 3 — Top',
    'Column 3 — Bottom',
    'Column 4 — Top (Small)',
    'Column 4 — Bottom (Tall)',
  ];

  return (
    <div>
      <h2 className="text-2xl font-bold text-white mb-1 font-heading">Team Photos</h2>
      <p className="text-white/40 text-sm mb-8">Upload 7 photos for the "We Are A Team Of Certified Developers" masonry grid on the homepage.</p>
